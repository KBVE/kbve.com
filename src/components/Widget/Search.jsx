  ...
  if (query) {
    return (
      ...
      <div className="space-x-2">
        ...
        <button type="button" className="px-8 py-3 font-semibold rounded shadow-2xl ring-2 ring-fushsia-900/5  dark:bg-gray-100 dark:text-gray-800" onClick={onClickUrl(`https://kbve.com/search?q=${query}+site:stackoverflow.com`)}>+SOF</button>
        ...
        <button type="button" className="px-8 py-3 font-semibold rounded shadow-2xl ring-2 ring-fushsia-900/5  dark:bg-gray-100 dark:text-gray-800" onClick={onClickUrl(`https://duckduckgo.com/?q=${query}&kp=-1&kl=us-en`)}>DDG</button>
