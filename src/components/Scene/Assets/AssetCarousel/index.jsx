...
const data = await fetch('https://kbve.com/asset/asset.json').then((response) =>
  response.json()
);
        ...
        >
          {data.map((resource, index) => {
            return (
              <div
                key={index}
                className="carousel-item text-center relative snap-start rounded shadow-sm"
                >
                  {/* <a
                    href={resource.slug}
                  ...
                  >
                    ...
                    {console.log(resource)}
                      <div className="rounded-md shadow-md bg-offset hover:opacity-100">
                          <div className="flex items-center justify-between p-3">
                            <div className="flex items-center space-x-2">
                              ...
                              <div className="-space-y-1">
                                <h2 className="text-sm font-semibold leading-none">{resource.title}</h2>
                          ...
                          <img src={resource.img} alt="" className="px-2 object-cover object-center w-full h-72 dark:bg-gray-500" />
                          <div className="p-3">
                            ...
                            <div className="flex flex-wrap items-center pt-3 pb-1">
                              <div className="flex items-center space-x-2">
                                ...
                                <span className="text-sm">Liked by
                                  <span className="font-semibold"> KBVE* </span> and 
                            ...
                            <div className="space-y-3">
                              ...
                              <input type="text" placeholder="Add a comment...Work In Progress" className="w-full py-0.5 dark:bg-transparent border-none rounded text-sm pl-0 dark:text-gray-100" />
                            </div>
                          </div>
                      </div>
                    {/* End Card */}
