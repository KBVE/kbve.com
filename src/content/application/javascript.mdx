...
JavaScript / JS is an object-oriented computer programming language that has evolved into an industry leading collection of libraries, packages and frameworks, which are used to create dynamic and interactive web pages, as well as applications, games, and more.
