...
<TabMenu first="intro" data={["cheatsheet", "system", "errors", "videos", "notes"]}>

<TabData tail="block" data="intro">
...
Exact break down of the installation process will be under the System tab, located above.
