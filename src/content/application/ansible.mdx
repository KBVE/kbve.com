...
<Details data="Metaphor for Ansible">
Think of it like: 
...
<Details data="Ansible described for a 5yr old!">
...
<Details data="Need extra installation help?">
...
##### 04-10-2023
Going to update the basics of the documentation. I will go back and add more information next week.
</Details>
### License
