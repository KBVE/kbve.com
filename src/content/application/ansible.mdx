...
The general concept of the inventory is similar to a collection of all the nodes within your organization. Inventory files are a key component of Ansible, and are essential for automating tasks on managed nodes or “hosts” in your infrastructure. With inventory files, you can easily pass host names at the command line, and quickly manage your entire infrastructure.
