...
description: Open source resume builder by KBVE Team
...
The input of the resume data might be better in markdown? I will come back to this part when I get a bit closer towards the render aspect.
