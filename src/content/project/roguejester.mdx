...
-> Updates:
  ...
  > Issue 70 (currency) : https://github.com/KBVE/roguejester/issues/70
  andsam to create a concept document on the currency (Khash,Credd,Coupon)
...
-> andsam configuring environment
-> andsam to high level set design for Town 
