...
- "KBVE" means all software, services, programs and applications that stem from KBVE.com, KBVE HOLDINGS LLC, ALAP INC and/or its affiliates.
...
- "Application" means the software program provided by the Company downloaded by You through an Application Store's account to a Device, named KBVE, KBVE RogueJester, KBVE.com

- "Application Store" means the digital distribution service operated and developed by Apple Inc. (Apple App Store) and/or Google Inc. (Google Play Store) and/or Valve Inc. (Steam Store) by which the Application has been downloaded to your Device, named KBVE and/or published by KBVE.com

- "Company" (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to KBVE

- "Country" refers to: United States of America

- "Device" means any device that can access the Application such as a computer, a cellphone, an electronic entity or a digital tablet.
...
By visiting this page on our website: [Support & Contact Us](https://kbve.com/support/)
